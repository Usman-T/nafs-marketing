        ...
        >
          <div className="w-full text-center lg:text-left">
            ...
            >
              ...
              <p className="mt-2 mx-auto lg:ml-0 text-[#a89984] text-base leading-relaxed max-w-lg">
                {description}
              </p>
            </motion.div>

            <div className="mt-6 mx-auto lg:ml-0 w-full space-y-6">
        ...
        >
          ...
          >
            <Image
              ...
              height={762}
              quality={100}
              className="lg:ml-0 rounded-2xl shadow-xl"
            />
          </div>
        </div>
      </motion.div>
